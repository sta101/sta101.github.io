...
To answer this question, we computed $Pr(\hat{p} \geq .87 | H_0 \text{ true})$. In words, the probability that our statistic of interest, ($\hat{p}$), is greater than or equal to what we saw given that the null is true.
