...
- [Final project](/projects/finalProject) proposal due Friday
...
The `stent30` data set comes from the `openintro` package and is from a study conducted in 2011 on the affects of arterial stents as a therapy for stroke patients. See the original publication:
...
Hypothesis testing framework: does NC Courage score a significantly different number of points away than at home?
...
To answer the question *does NC Courage score a significantly different number of points away than at home?*
...
Using your hypothesis test form exercise 2, report the p-value associated with the lower-bound of your confidence interval as the observed statistic. What do you notice?
...
diabetes = courage = read_csv("https://sta101.github.io/static/appex/data/diabetes.csv")
```
