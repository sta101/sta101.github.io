...
- acquire some new skills to help with the final project report

## Getting started

Download this application exercise by pasting the code below into your **console**

    download.file("https://sta101.github.io/static/appex/ae14.Rmd",
    destfile = "ae14.rmd")
...
Write the equation of the interaction effects model pictured above to predict the number of bikes rented on a given day based on the temperature outside and whether or not the day is a holiday.
...
$$
T = \frac{\hat{\beta} - 0}{\text{SE}_{\hat{\beta}}} \sim t_{n - 3}
$$
...
Calculate the p-value associated with $\beta_{holiday}$ manually using the equation above. Note: in a regression setting, the degrees of freedom is the number of observations minus the number of predictors.
